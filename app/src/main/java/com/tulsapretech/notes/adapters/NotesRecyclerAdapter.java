/*
   ...
   File Name: NotesRecyclerAdapter.java
 */

package com.tulsapretech.notes.adapters;
...
import com.tulsapretech.notes.R;


import com.tulsapretech.notes.models.Note;
import com.tulsapretech.notes.util.Utility;
...
public class NotesRecyclerAdapter extends RecyclerView.Adapter<NotesRecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        try{
            ...
            Log.d(TAG,"BindViewHolder Failure!! ln 45-55");
        }
